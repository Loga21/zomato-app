  ...
  return (
    <>
      <div className='ms-2 row product-cards'>
        ...
        // : (sortedFood.length > 0)
        //     ? sortedFood && sortedFood?.map((food) => {
        //       return (
        //   <div className='col-md-4' key={food.id}>
        //     <div className='card p-2 shadow mb-4 bg-body-tertiary rounded'>
        //       <div className='position-relative'>
            ...
            return (
                <div className='col-md-4' key={food.id}>
                  <div className='card p-2 shadow mb-4 bg-body-tertiary rounded'>
                    ...
                    <div className='card-body d-flex justify-content-between'>
                      <div>
                        <div className='card-title fs-5 product-title text-decoration-none m-0'>
                          {food.hotelName}
                        </div>
                        <div className='text-secondary mb-2'>{food.cuisineName}</div>
                        <div>
                          <button
                            className='btn btn-warning btn-sm'
                            onClick={handleAddToCart.bind(this, food)}>
                      ...
                      <div className='text-end mt-2'>
                        ...
                        <p className='card-text text-secondary m-0 mt-1 mb-2'>₹{food.price} for one</p>
                        <p className='text-secondary m-0'>{food.timeTaken} min</p>
                      </div>
                    </div>
                    <hr className='m-0 text-secondary' />
